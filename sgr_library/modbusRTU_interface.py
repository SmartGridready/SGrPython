...
from sgr_library.driver.modbusRTU_client import SGrModbusRTUClient
...
class SgrModbusRtuInterface:
    ...
    def __init__(self, frame: DeviceFrame) -> None:
        ...
        self.port = get_port(
            self.root
        )  # TODO überlegungen machen wo Port untergebracht wird
    ...
    def getval(self, *parameter) -> float:
        ...
        return self.client.value_decoder(
    ...
    def get_device_profile(self):
        ...
        print(
            f"Level of Operation: {self.root.device_profile.dev_levelof_operation}"
        )
    ...
    def get_register_type(self, dp) -> str:
        ...
        """
        register_type = dp.modbus_data_point[
            0
        ].modbus_first_register_reference.register_type.value
    ...
    def get_bit_rank(self, dp):
        bitrank = dp.modbus_data_point[
            0
        ].modbus_first_register_reference.bit_rank
        return bitrank
